...
const Specialist = (props: ISpecialistProps) => {
  ...
  return (
    <>
      <div className={`w-full md:w-[230px] border-b-2 border-slate-600 md:mx-5 my-5 lg:my-0 ${props.margin ? 'lg:mt-[60px]' : ''}`} >
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-black font-semibold text-[14pt]">{props.name}</p>
          <p className="text-[17px] mb-1">{props.position}</p>
        </div>
      </div>
    </>
  )
